                ...
                <div class="col-md-8 col-sm-10 col-xs-12 col-centered clearfix">
                    <form runat="server" id="InputForm">
                        <div class="input-group">
                            ...
                            <input id="username" runat="server" class="form-control validate[required]" placeholder="Username or Email" type="text" />
                            <input id="email"  type="text" class="form-control" name="email" placeholder="Email" runat="server">
                        </div>
                        <div class="input-group">
                        ...
                        <div>
                            <%--<button type="submit" class="btn btn-round btn-red btn-block" runat="server" onclick="">Login</button>--%>
                               <asp:Button CssClass="btn btn-primary btn-block" runat="server" ClientIDMode="Static" ID="BtnLogin" OnClick="" Text="Log in" OnClientClick="return IsValidLoginForm()" />
                        </div>
